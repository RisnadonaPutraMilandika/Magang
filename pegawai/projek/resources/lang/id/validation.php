...
return [
    ...
    */
    ...
    'custom' => [
        'nip' => [
            'required' => 'Kolom Nomor Pegawai harus diisi',
            'string' => 'Kolom Nomor Pegawai harus berupa string',
            'size' => 'Kolom Nomor Pegawai harus :size angka',
            'unique' => 'Nomor Pegawai sudah terpakai',
        ],
        'nama' => [
        ...
        'nomor_telepon' => [
            ...
            'date' => 'Nomor telepon harus diisi angka',
    ...
    'foto' => [
        ...
        'max' => 'Kolom FOTO tidak bleh lebih dari 500kb.',
    ...
    'nama_jabatan' => [
        'required' => 'Kolom Jabatan Harus diisi',
        'string' => 'Kolom Jabatan harus string',
        'max' => 'Kolom Jabatan maksimum 20 karakter',
    ],  

    'jumlah_gaji' => [
        'required' => 'jumlah gaji Harus diisi',
        'string' => 'jumlah gaji harus string',
        'max' => 'jumlah gaji maksimum 30 karakter',
    ],  
],
    /*
    |--------------------------------------------------------------------------
